...
Ruby (Sinatra) demo app for Deepgram Transcription.
...
```
feat(ruby-transcription): add diarization support
fix(ruby-transcription): resolve WebSocket close handling
refactor(ruby-transcription): simplify session endpoint
